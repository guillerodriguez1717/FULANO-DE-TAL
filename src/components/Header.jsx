  ...
  return <>
    ...
    <header>
      ...
      <div className="header-actions">
        <button className="search-button" aria-label="Buscar productos" onClick={onSearch}><Search/></button>
        <button className="whatsapp" onClick={() => navigate('contact')}>Hablemos</button>
        <button className="menu-button" onClick={() => setMenu(true)} aria-label="Abrir menú"><Menu/></button>
      </div>
    </header>
  </>
}

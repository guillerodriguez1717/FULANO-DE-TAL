...
const weeklyOffers = [
  { category: 'Muebles', title: 'Oferta en preparación', text: 'El mueble elegido de la semana va a aparecer acá, con precio y condiciones confirmadas.', saying: '¡A la flauta! Cuando aparece una buena, hay que pispearla.' },
...
function Home({ navigate, openProduct }) {
  ...
  return <main>
    ...
    <section className="section products-section catalog-coming"><SectionTitle eyebrow="Catálogo en preparación" title="Acá van a aparecer los productos de verdad" text="Estamos preparando el lugar para cargar muebles y productos con información confirmada: precio, medidas, plazo, entrega y condiciones."/><div className="catalog-coming-paper"><b>Fulano dice:</b><span>“Antes de llenar la vidriera por llenar, mejor esperar el dato bueno. Cuando lleguen los catálogos, acá los acomodamos como corresponde.”</span><button className="secondary" onClick={() => navigate('catalog')}>Ver categorías preparadas</button></div></section>
